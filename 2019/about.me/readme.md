...
[![Anurag's github stats](https://github-readme-stats.vercel.app/api?username=steady)](https://github.com/anuraghazra/github-readme-stats)

这一个Hacker Style风格化的自我简介的JS模板

在线动态演示：https://steady.github.io/about.me

### usage

在steady.html的 `source` 元素输入需要打印的内容，再次运行，`output-wrap`元素即会进行动态打印输出信息到网页上。
